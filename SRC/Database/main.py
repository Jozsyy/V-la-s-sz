...
database.child("Felhasznalok").child("Felhasznalo2").set(felhasznalo2)
...
database.child("Felhasznalok").child("Felhasznalo3").set(felhasznalo3)
...
#Kerdesek tabla
#MATEMATIKA
kerdes1 = {"Kerdes_ID": "00000000", "Kerdes":"Mennyi a PI értéke?","Kategoria_ID":"Matematika", "Felhasznalo_ID":"00000"}
database.child("Kerdesek").child("Kerdes1").set(kerdes1)


#FOLDRAJZ-TORTENELEM
kerdes2 = {"Kerdes_ID": "00000002", "Kerdes":"Hany kontinens kezdodik 'A'-betuvel?","Kategoria_ID":"Foldrajz-Tortenelem", "Felhasznalo_ID":"00000"}
database.child("Kerdesek").child("Kerdes2").set(kerdes2)

#ELOVILAG
kerdes3 = {"Kerdes_ID": "00000003", "Kerdes":"Hol elnek a pingvinek?","Kategoria_ID":"Elovilag", "Felhasznalo_ID":"00000"}
database.child("Kerdesek").child("Kerdes3").set(kerdes3)

#SPORT
kerdes4 = {"Kerdes_ID": "00000004", "Kerdes":"Melyik orszag nyerte a 2018-as VB-t?","Kategoria_ID":"Sport", "Felhasznalo_ID":"00000"}
database.child("Kerdesek").child("Kerdes4").set(kerdes4)

#TUDOMANYOS
kerdes5 = {"Kerdes_ID": "00000005", "Kerdes":"Mikor halt meg Albert Einstein?","Kategoria_ID":"Tudomanyos", "Felhasznalo_ID":"00000"}
database.child("Kerdesek").child("Kerdes5").set(kerdes5)

#ALTALANOS
kerdes6 = {"Kerdes_ID": "00000006", "Kerdes":"Minek a rövidítése a CD?","Kategoria_ID":"Altalanos", "Felhasznalo_ID":"00000"}
